                ...
                <div className="grid gap-12 lg:grid-cols-3">
                    <div className="col-span-1 lg:col-span-1">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h2 className="text-xl font-bold text-foreground">Gordito Blendz</h2>
                        </div>
                        <p className="text-sm text-secondary">
                            Mastering the art of modern grooming. Precision cuts, expert styling, and a premium atmosphere.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a className="text-sm text-secondary hover:text-primary" href="#">Gallery</a></li>
                            <li><a className="text-sm text-secondary hover:text-primary" href="#">About Us</a></li>
                            <li><a className="text-sm text-secondary hover:text-primary" href="#">Contact Us</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="mb-4 text-sm font-bold uppercase tracking-wider text-foreground">Hours</h3>
                        <p className="text-sm text-secondary">
                            Currently by appointment only
                        </p>
                    </div>
                </div>
                <div className="mt-16 border-t border-border pt-8 text-center sm:text-left">
                    <p className="text-xs text-secondary">
                        © 2026 Gordito Blendz. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
